...
export default function PricingCtaSection() {
  ...
  return (
    <section ref={sectionRef} id="pricing" data-theme="dark" className="relative w-full py-[120px] bg-charcoal overflow-hidden">
      {/* Floating orbs */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          className="absolute w-[400px] h-[400px] rounded-full animate-float-1 opacity-[0.04]"
          style={{ background: '#8FBC8F', filter: 'blur(100px)', top: '10%', left: '20%' }}
        />
        <div
          className="absolute w-[500px] h-[500px] rounded-full animate-float-2 opacity-[0.03]"
          style={{ background: '#8FBC8F', filter: 'blur(100px)', top: '40%', right: '10%' }}
        />
        <div
          className="absolute w-[350px] h-[350px] rounded-full animate-float-3 opacity-[0.04]"
          style={{ background: '#8FBC8F', filter: 'blur(100px)', bottom: '10%', left: '50%' }}
        />
      </div>
      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-[55%]">
            <p className="cta-text text-xs font-medium uppercase tracking-[0.1em] text-sage-light mb-3">
              Download the App
            </p>
            <div className="cta-text w-10 h-0.5 bg-sage mb-6" />
            ...
            <div className="cta-text flex flex-wrap gap-4 mb-6">
              <div className="w-[140px] h-[48px] bg-white rounded-lg flex items-center justify-center cursor-pointer hover:brightness-110 transition-all duration-200">
                <div className="text-charcoal text-xs font-semibold flex items-center gap-2">
